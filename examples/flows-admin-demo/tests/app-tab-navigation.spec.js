...
test.describe('Application Tab Navigation', () => {
  test('should navigate between onboarding and offboarding tabs and show distinct content', async ({ page }) => {
    await page.goto('/');
  ...
  test('should show application-specific UI elements when available', async ({ page }) => {
    ...
    for (let i = 0; i < appTabs.length; i++) {
      ...
      const uiElements = {
        ...
        'Navigation buttons': page.locator('button[data-testid*="view-"], button[data-testid*="-view-"]'),
        'Overview section': page.locator('[data-testid*="overview"], [data-testid*="view-overview"]'),
        'Templates section': page.locator('[data-testid*="templates"], [data-testid*="view-templates"]'),
        'Processes section': page.locator('[data-testid*="processes"], [data-testid*="view-processes"]'),
