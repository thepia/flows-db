    ...
    tasks: [
      {
        ...
        instructions: 'Contact HR to schedule a 60-minute exit interview session. Prepare questions about employee experience and improvement suggestions.',
        ...
        documents: [
          { name: 'Exit Interview Form', document_type: 'form', is_mandatory: true }
        ]
      },
      {
        name: 'Complete Equipment Return',
        description: 'Return all company equipment',
        instructions: 'Collect and return laptop, phone, badge, keys, and any other company property. Obtain signed receipt.',
      ...
      },
      {
        ...
        instructions: 'Create comprehensive documentation of daily tasks, ongoing projects, and important contacts.',
        ...
        documents: [
          { name: 'Handover Document Template', document_type: 'handover_document', is_mandatory: true }
        ]
      },
      {
        name: 'Access Revocation Review',
        description: 'Review and revoke all system access',
        instructions: 'Systematically review and revoke access to all systems, applications, and physical spaces.',
      ...
      },
      {
        ...
        instructions: 'Calculate final pay, process unused vacation time, coordinate COBRA/benefits transition.',
    ...
    tasks: [
      {
        ...
        instructions: 'Remove access to GitHub, GitLab, and any other code repositories. Review commit history for sensitive information.',
        category: 'access_revocation',
        estimated_hours: 1.0,
        sort_order: 1,
        default_assignee_role: 'it_administrator',
      ...
      },
      {
        ...
        instructions: 'Create detailed documentation of system architecture, deployment processes, and technical decisions.',
        ...
        approval_role: 'direct_manager',
        documents: [
          { name: 'Technical Architecture Document', document_type: 'knowledge_base', is_mandatory: true },
          { name: 'Deployment Process Guide', document_type: 'procedure_guide', is_mandatory: true }
        ]
      },
      {
        name: 'Active Project Transition',
        description: 'Transition ownership of active development projects',
        instructions: 'Meet with team to discuss project status, blockers, and next steps. Assign new project owners.',
      ...
      },
      {
        ...
        instructions: 'Remove production environment access, update on-call rotations, transfer monitoring responsibilities.',
        category: 'access_revocation',
        estimated_hours: 2.0,
        sort_order: 4,
        default_assignee_role: 'it_administrator',
      ...
      },
      {
        ...
        instructions: 'Ensure all code, documentation, and technical assets are properly transferred and secured.',
        category: 'compliance',
        estimated_hours: 1.5,
        sort_order: 5,
    ...
    tasks: [
      {
        ...
        instructions: 'Create detailed client profiles, relationship history, and introduce replacement contacts to key clients.',
        category: 'knowledge_transfer',
        estimated_hours: 6.0,
        sort_order: 1,
        default_assignee_role: 'departing_employee',
        ...
        approval_role: 'direct_manager',
        documents: [
          { name: 'Client Relationship Transfer Document', document_type: 'handover_document', is_mandatory: true },
      ...
      },
      {
        ...
        instructions: 'Update CRM with detailed opportunity status, next steps, and transfer ownership to designated team members.',
        category: 'transition_planning',
        estimated_hours: 4.0,
        sort_order: 2,
        default_assignee_role: 'departing_employee',
      ...
      },
      {
        ...
        instructions: 'Calculate final commission payments, update quota achievement records, and process any pending deals.',
        category: 'final_procedures',
        estimated_hours: 3.0,
        sort_order: 3,
        default_assignee_role: 'hr_representative',
      ...
      },
      {
        ...
        instructions: 'Transfer data ownership in CRM, remove access, and ensure all client data is properly secured.',
        category: 'access_revocation',
        estimated_hours: 1.5,
        sort_order: 4,
        default_assignee_role: 'it_administrator'
      },
      {
        ...
        instructions: 'Develop communication plan for informing clients about account manager changes.',
    ...
    tasks: [
      {
        ...
        instructions: 'Create comprehensive documentation of strategic initiatives, long-term vision, and key strategic relationships.',
        category: 'knowledge_transfer',
        ...
        approval_role: 'department_head',
        documents: [
          { name: 'Strategic Vision Document', document_type: 'knowledge_base', is_mandatory: true },
          { name: 'Key Relationships Directory', document_type: 'contact_list', is_mandatory: true }
        ]
      },
      {
        name: 'Board and Stakeholder Communication',
        description: 'Coordinate communication with board and key stakeholders',
        instructions: 'Develop communication strategy for board members, investors, and key external stakeholders.',
        category: 'communication',
        estimated_hours: 4.0,
        sort_order: 2,
        default_assignee_role: 'departing_employee',
      ...
      },
      {
        ...
        instructions: 'Meet with direct reports, discuss transition plans, and formally transfer leadership responsibilities.',
        category: 'transition_planning',
        estimated_hours: 8.0,
        sort_order: 3,
        default_assignee_role: 'departing_employee',
        documents: [
          { name: 'Leadership Transition Plan', document_type: 'procedure_guide', is_mandatory: true }
        ]
      },
      {
        name: 'Confidentiality and Non-Compete Review',
        description: 'Review confidentiality agreements and legal obligations',
        instructions: 'Comprehensive review of all legal agreements, confidentiality requirements, and post-employment obligations.',
        category: 'compliance',
        estimated_hours: 2.0,
        sort_order: 4,
        default_assignee_role: 'hr_representative',
      ...
      },
      {
        ...
        instructions: 'Update bank signatures, transfer financial system access, and document budget responsibilities.',
        category: 'access_revocation',
        estimated_hours: 3.0,
        sort_order: 5,
        default_assignee_role: 'hr_representative',
    ...
    tasks: [
      {
        ...
        instructions: 'Document all systems with administrative access, create access inventory, and plan secure transfer.',
        category: 'access_revocation',
        estimated_hours: 4.0,
        sort_order: 1,
        default_assignee_role: 'departing_employee',
        ...
        approval_role: 'security_officer',
        documents: [
          { name: 'Administrative Access Inventory', document_type: 'checklist', is_mandatory: true }
        ]
      },
      {
        name: 'Critical System Documentation',
        description: 'Document critical system configurations and procedures',
        instructions: 'Create detailed documentation of system configurations, emergency procedures, and maintenance schedules.',
        category: 'documentation',
        ...
        approval_role: 'direct_manager',
        documents: [
          { name: 'System Configuration Guide', document_type: 'knowledge_base', is_mandatory: true },
          { name: 'Emergency Response Procedures', document_type: 'procedure_guide', is_mandatory: true }
        ]
      },
      {
        name: 'Security Credential Transfer',
        description: 'Secure transfer of security credentials and certificates',
        instructions: 'Transfer security certificates, API keys, and other credentials through secure channels.',
        category: 'access_revocation',
        estimated_hours: 3.0,
        sort_order: 3,
        default_assignee_role: 'security_officer',
      ...
      },
      {
        ...
        instructions: 'Test backup systems, verify recovery procedures, and ensure continuity of critical operations.',
        category: 'compliance',
        estimated_hours: 4.0,
        sort_order: 4,
        default_assignee_role: 'it_administrator',
      ...
      },
      {
        ...
        instructions: 'Update vendor contacts, transfer support relationships, and document service agreements.',
        category: 'transition_planning',
        estimated_hours: 2.0,
        sort_order: 5,
        default_assignee_role: 'departing_employee',
