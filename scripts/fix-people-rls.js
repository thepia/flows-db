...
const supabaseServiceKey = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpzdGJrdmt1cmpzb3B1d2hsc3Z5Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MDk2NjU2OCwiZXhwIjoyMDY2NTQyNTY4fQ.vSSYVzitJDrQQYer1cW-SU_ZSEUtVyIOKsogHjy3h58';
      ...
      for (let i = 0; i < statements.length; i++) {
        ...
        if (statement && !statement.startsWith('--') && statement !== ';') {
          ...
          try {
            ...
            console.log(chalk.yellow(`Warning: Statement ${i + 1} had issues: ${statementError.message}`));
          }
        }
      }
